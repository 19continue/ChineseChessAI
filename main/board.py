...
class Renderer:
    ...
    def draw_last_move(self,player):
        if player.last_move and player.last_move[0] != '-':
...
class Player:
    ...
    def get_action(self,state_deque,current_player,opponent_general_position,opponent_move=None):
        action=None
...
class Board:
    def __init__(self,player1,player2,offensive=1,renderer:Renderer=None):
        ...
        self.player_agent[1].last_move = "-1"
        self.player_agent[-1].last_move = "-1"
